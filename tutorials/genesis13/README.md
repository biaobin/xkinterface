...
1. Modify `create_jobs.py` to create batch files for the job submission, one needs to define:
...
2. Modify `run_job4.py` to prepare input files for `Genesis1.3 Version 4`, usually, one has to define:
...
3. How to generate input for `Genesis1.3`
